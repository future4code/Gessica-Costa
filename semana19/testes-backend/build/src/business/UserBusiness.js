...
class UserBusiness {
    ...
    getAllUsers(role) {
        return __awaiter(this, void 0, void 0, function* () {
            if (User_1.stringToUserRole(role) !== User_1.UserRole.ADMIN) {
                throw new UnauthorizedError_1.UnauthorizedError("You must be an admin to acess this endpoint");
            }
    ...
    getProfile(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield this.userDatabase.getProfile(id);
            if (!user) {
                throw new NotFoundError_1.NotFoundError("User not found");
            }
            return {
